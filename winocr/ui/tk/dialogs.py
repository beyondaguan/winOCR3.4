...
dialogs_misc，本文件统一 re-export，保持旧 import（from .dialogs import ...）兼容。
"""
from .dialogs_common import (
    _post_to_ui, _center, _modal, _ScrollableFrame,
    _record_key, _hotkey_status,
)
from .dialogs_settings import (
    open_hotkey_settings, open_api_settings,
    _test_ai, _test_translate, _test_ocr,
)
